...
const HandsOn = () => {
    const [activeTab, setActiveTab] = useState('simulators'); // 'games' or 'simulators'
            ...
            >
                ...
                <div className="max-w-7xl mx-auto mb-10">
                    ...
                    <p className="text-secondary text-lg max-w-2xl leading-relaxed">
                        The ultimate training ground. Master complex systems through interactive simulations and real-world network challenges.
                    </p>
                </div>

                {/* Tab Switcher */}
                <div className="max-w-7xl mx-auto mb-12">
                    <div className="inline-flex p-1.5 bg-slate-800/40 rounded-[2rem] border border-white/5 backdrop-blur-xl">
                        <button
                            ...
                            <div className="glass-panel overflow-hidden border-cyan-500/20 shadow-2xl shadow-cyan-500/5">
                                <div className="p-6 border-b border-white/5 flex items-center justify-between bg-white/5">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <h3 className="font-bold text-primary">Cisco Packet Tracer Web</h3>
                                            <p className="text-[10px] text-secondary uppercase tracking-widest mt-0.5">V7.0 Simulation Engine</p>
                                        </div>
                                    </div>
                                ...
                                <div className="aspect-video w-full bg-black relative group">
                                    <iframe
                                        src="https://visualizer.network/embed"
                                        title="Network Simulator"
                                        className="w-full h-full border-none"
                                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                        allowFullScreen
                                    />
                                    {/* Subtitle for Simulator */}
                                ...
                                <div className="p-8 grid grid-cols-1 md:grid-cols-3 gap-8 bg-slate-800/20">
                                    <div className="space-y-2">
                                        <h4 className="text-sm font-bold text-cyan-400">Drag & Drop Devices</h4>
                                        <p className="text-xs text-secondary leading-relaxed">Add routers, switches, and PCs to build your enterprise topology directly in the browser.</p>
                                    </div>
                                    <div className="space-y-2">
                                        <h4 className="text-sm font-bold text-cyan-400">CLI Configuration</h4>
                                        <p className="text-xs text-secondary leading-relaxed">Enter terminal mode on any device to practice Cisco IOS commands and routing protocols.</p>
                                    </div>
                                    <div className="space-y-2">
                                        <h4 className="text-sm font-bold text-cyan-400">Real-time Analysis</h4>
                                        <p className="text-xs text-secondary leading-relaxed">Trace packet flow and inspect headers at every layer of the OSI model in real-time.</p>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
